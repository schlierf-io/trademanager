var TradingView = (function (t) {
  ...
  function s(t, e) {
    const n = new URL(`${t || ""}`, location.href).href,
      i = JSON.parse(
        '["bundles/runtime.1f94b178619614f66d6f.js","bundles/__LANG__.8113.6effbc8b6375d6a16597.js","bundles/7717.8f75bd75d4b6ed45f3ff.css","bundles/7717.8f75bd75d4b6ed45f3ff.rtl.css","bundles/4618.8061482aab540c66eb1f.js","bundles/library.63466897dbd7710a003a.js","bundles/EuclidCircular.be8f862db48c2976009f.woff2"]'
      ),
      s = JSON.parse(
  ...
  function r() {
    return "CL v24.001 (internal id e00f16c2 @ 2023-03-13T14:20:02.318Z)";
  }
  const a = class {
    constructor(t) {
      var o;
      ...
      (null === (o = t.overrides) || void 0 === o
        ...
        this._options.debug &&
          (i ||
            ((i = !0),
            console.log(
              "Using CL v24.001 (internal id e00f16c2 @ 2023-03-13T14:20:02.318Z)"
            ))),
        this._create();
    }
    setDebugMode(t) {
    ...
    _render(t) {
      ...
      const n = s(this._options.library_path || "", this._options.locale);
